...
if strcmp(cmnd_str,'initialize')
    ...
    objs_change_col(4)=uicontrol(dat.fig_id,...
        'Units','normalized', ...
        'Position',[ 0.505 0.09 0.26 0.075 ],... %hier das m�sste weter zum Boden reichen, damit es das andere Fenster inschlie�t
    ...
    objs_change_col(6)=uicontrol(dat.fig_id,...
        'Units','normalized', ...
        'Position',[ 0.005 0.221 0.05 0.03 ],... % H�he war 0.183
        'String','Stat:',...
